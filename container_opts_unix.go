...
func WithRemappedSnapshot(id string, i Image, uid, gid uint32, remapper string) NewContainerOpts {
	return withRemappedSnapshotBase(id, i, uid, gid, false, remapper)
}

// WithRemappedSnapshotView is similar to WithRemappedSnapshot but rootfs is mounted as read-only.
func WithRemappedSnapshotView(id string, i Image, uid, gid uint32, remapper string) NewContainerOpts {
	return withRemappedSnapshotBase(id, i, uid, gid, true, remapper)
}

func withRemappedSnapshotBase(id string, i Image, uid, gid uint32, readonly bool, remapper string) NewContainerOpts {
	return func(ctx context.Context, client *Client, c *containers.Container) error {
		if remapper != "chown" && remapper != "fuse-overlayfs" {
			return errors.New("remapper must be either 'chown' or 'fuse-overlayfs'")
		}
